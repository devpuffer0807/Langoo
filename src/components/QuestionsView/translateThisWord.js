...
class TranslateThisWord extends Component {
  constructor(props) {
    super(props);
    this.mounted = true;
    let langCode = getLangCode();
    let {question, language} = props;
    let {defaultText, questionText, questionsName, name, options} = question;
...
TranslateThisWord.propTypes = {
  question: PropTypes.object.isRequired,
  onContinue: PropTypes.func.isRequired,
};

export default TranslateThisWord;
